...
SECRET_KEY = 'django-insecure-5jhiueba)8icf3i4q=8_ndp#b3nac!ig1a*pu(fxwg2hh)jtw6'

# TailwindCSS NPM_BIN_PATH, uncomment the line if needed
# It has to point to the NPM executable
# NPM_BIN_PATH = ''
